...
export default function Home() {
  ...
  return (
    <div className="flex flex-col justify-center h-screen">
      ...
      <form className="flex flex-col items-center mt-44 flex-grow w-4/4">
        <Image
          src="https://www.google.bg/images/branding/googlelogo/1x/googlelogo_color_272x92dp.png"
          height={100}
          width={300}
        />
        <div className="flex w-full mt-5 hover:shadow-lg focus-within:shadow-lg max-w-md rounded-full border border-gray-200 px-5 py-4 items-center sm:max-w-xl lg:max-w-2xl">
